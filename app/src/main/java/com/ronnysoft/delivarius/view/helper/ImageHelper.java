...
public class ImageHelper {
    ...
    public static void setImageViewProduto(ImageView imageView, String image){
        ...
        switch (image) {
            ...
            case "gelo_qualita_5kg.png" :
                ...
                break;
            default:
                imageView.setImageResource(R.drawable.produto_icon_default);
                break;
        }

    }
    public static void setImageViewloja(ImageView imageView, String image){
        ...
        switch (image) {
            ...
            case "super_conveniencia_horizonte.png" :
                ...
                break;
            default:
                imageView.setImageResource(R.drawable.loja_icon_default);
                break;
        }
